#############################################################################
# Makefile for building: src.app/Contents/MacOS/src
# Generated by qmake (3.1) (Qt 6.7.3)
# Project:  src.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile src.pro
#############################################################################
...
SOURCES       = brick_game/snake/src/engine.cpp \
		...
		gui/desktop/screens/menu/menu_view.cpp qrc_resources.cpp \
		moc_animated_button.cpp \
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		gui/desktop/screens/template/controller.hpp brick_game/snake/src/engine.cpp \
		brick_game/snake/src/variables.cpp \
		gui/desktop/src/app.cpp \
		gui/desktop/screens/game/game_controller.cpp \
		gui/desktop/screens/game/game_view.cpp \
...
QMAKE_TARGET  = src
DESTDIR       = 
TARGET        = src.app/Contents/MacOS/src
...
src.app/Contents/MacOS/src:  $(OBJECTS)  
	@test -d src.app/Contents/MacOS/ || mkdir -p src.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: src.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/macx.conf \
...
src.app/Contents/PkgInfo: 
	@test -d src.app/Contents || mkdir -p src.app/Contents
	@$(DEL_FILE) src.app/Contents/PkgInfo
	@echo "APPL????" > src.app/Contents/PkgInfo
src.app/Contents/Info.plist: 
	@test -d src.app/Contents || mkdir -p src.app/Contents
	@$(DEL_FILE) src.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,pauldekarin.src,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},pauldekarin.src,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,src,g" -e "s,@LIBRARY@,src,g" -e "s,\$${EXECUTABLE_NAME},src,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >src.app/Contents/Info.plist

all: Makefile \
		src.app/Contents/PkgInfo \
		src.app/Contents/Info.plist src.app/Contents/MacOS/src
...
distdir: FORCE
	...
	$(COPY_FILE) --parents gui/desktop/app.hpp gui/desktop/settings.hpp brick_game/snake/include/db.hpp brick_game/snake/include/engine.hpp brick_game/snake/include/observer.hpp gui/desktop/styles/proxy.hpp gui/desktop/components/animated_button/animated_button.hpp gui/desktop/components/shadow/shadow.hpp gui/desktop/screens/game/game_controller.hpp gui/desktop/screens/game/game_view.hpp gui/desktop/screens/menu/menu_controller.hpp gui/desktop/screens/menu/menu_view.hpp gui/desktop/screens/template/controller.hpp $(DISTDIR)/
	$(COPY_FILE) --parents brick_game/snake/src/engine.cpp brick_game/snake/src/variables.cpp gui/desktop/src/app.cpp gui/desktop/screens/game/game_controller.cpp gui/desktop/screens/game/game_view.cpp gui/desktop/screens/menu/menu_controller.cpp gui/desktop/screens/menu/menu_view.cpp $(DISTDIR)/
...
qrc_resources.cpp: resources.qrc \
		...
		gui/desktop/fonts/n3310.ttf \
		gui/desktop/fonts/press2p.ttf \
		gui/desktop/styles/style.qss
...
compiler_moc_header_make_all: moc_animated_button.cpp moc_game_controller.cpp moc_game_view.cpp moc_menu_view.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_animated_button.cpp moc_game_controller.cpp moc_game_view.cpp moc_menu_view.cpp
moc_animated_button.cpp: gui/desktop/components/animated_button/animated_button.hpp \
		gui/desktop/settings.hpp \
		moc_predefs.h \
...
engine.o: brick_game/snake/src/engine.cpp brick_game/snake/include/engine.hpp \
		brick_game/snake/include/observer.hpp \
		brick_game/snake/include/db.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o engine.o brick_game/snake/src/engine.cpp

variables.o: brick_game/snake/src/variables.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o variables.o brick_game/snake/src/variables.cpp

app.o: gui/desktop/src/app.cpp gui/desktop/app.hpp \
		gui/desktop/screens/menu/menu_controller.hpp \
		brick_game/snake/include/db.hpp \
		gui/desktop/screens/template/controller.hpp \
		gui/desktop/screens/menu/menu_view.hpp \
		...
		gui/desktop/screens/game/game_view.hpp \
		gui/desktop/styles/proxy.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o app.o gui/desktop/src/app.cpp

game_controller.o: gui/desktop/screens/game/game_controller.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o game_controller.o gui/desktop/screens/game/game_controller.cpp

game_view.o: gui/desktop/screens/game/game_view.cpp gui/desktop/screens/game/game_view.hpp \
		brick_game/snake/include/engine.hpp \
		brick_game/snake/include/observer.hpp \
		brick_game/snake/include/db.hpp \
		gui/desktop/settings.hpp \
		gui/desktop/components/shadow/shadow.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o game_view.o gui/desktop/screens/game/game_view.cpp

menu_controller.o: gui/desktop/screens/menu/menu_controller.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o menu_controller.o gui/desktop/screens/menu/menu_controller.cpp

menu_view.o: gui/desktop/screens/menu/menu_view.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o menu_view.o gui/desktop/screens/menu/menu_view.cpp

qrc_resources.o: qrc_resources.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_resources.o qrc_resources.cpp

moc_animated_button.o: moc_animated_button.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_animated_button.o moc_animated_button.cpp

moc_game_controller.o: moc_game_controller.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_game_controller.o moc_game_controller.cpp

moc_game_view.o: moc_game_view.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_game_view.o moc_game_view.cpp

moc_menu_view.o: moc_menu_view.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_menu_view.o moc_menu_view.cpp
